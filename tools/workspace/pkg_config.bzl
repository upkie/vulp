...
_DEFAULT_TEMPLATE = Label("//tools/workspace:pkg_config.BUILD.tpl")
...
def setup_pkg_config_repository(repository_ctx):
    """
    This is the macro form of the pkg_config_repository() rule below. Refer to
    that rule's API documentation for details.
...
Args:
    ...
    build_epilog: (Optional) Extra text to add to the generated BUILD.
