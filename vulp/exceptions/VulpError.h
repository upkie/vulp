...
class VulpError : public std::runtime_error {
 public:
  /*! Create a new error.
   *
   ...
   */
  VulpError(const std::string& file, unsigned line, const std::string& message)
   ...
   */
  VulpError(const VulpError& other, const std::string& extra_message)
